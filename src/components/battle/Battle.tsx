      ...
      <div className="battle-hamster-container">
        {randomHamster ? (
          <div key={randomHamster.id} onClick={randomHamsterLeft}>
            ...
            {allInfoIsVisible ? (
              <div>
                <p>{winnerLeft ? <h4>LOSER</h4> : <h4>WINNER</h4>}</p>
                <p>
          ...
          <div className="battle-error-message">
            <p>Hämtar slumpad hamster från API</p>
          </div>
        )}
        ...
        {randomHamster2 ? (
          <div key={randomHamster2.id} onClick={randomHamsterRight}>
            ...
            {allInfoIsVisible ? (
              <div>
                <p>{winnerRight ? <h4>LOSER</h4> : <h4>WINNER</h4>}</p>
                <p>
